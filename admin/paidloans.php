            ...
            <div class="card-body">
              <div class="form-group row">
                ...
                <?php 
                  ...
                  $sql = "SELECT *, CONCAT('Php ', FORMAT(totalamount,2)) AS 'totalamount' FROM loanrequesttbl WHERE totalrequeststatus = 'Loan Paid';";  
                  ...
                  <tbody>
                    <?php 
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;"><a href="paidloansview.php?applicationno=<?php echo $row['loanrequestid']; ?>&memberid=<?php echo $row['memberid']; ?>" class="btn btn-primary btn-sm">View</a></td>
                      </tr>
                      <?php
                      }
                    ?>

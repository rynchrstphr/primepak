		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					$s = "SELECT loanrequesttbl.*, dateend, CONCAT('Php ',FORMAT(loanrequesttbl.totalamount,2)) AS bal, memberdetailstbl.* FROM loanrequesttbl INNER JOIN memberdetailstbl ON loanrequesttbl.memberid = memberdetailstbl.memberid WHERE loanrequesttbl.loanrequestid = '$loanrequestid';";
					$r = mysqli_query($db, $s);
                ...
                <div class="col-md-4">
                  <button onclick="window.open('loanPrint2.php?applicationno=<?php echo $_GET['applicationno']; ?>&memberid=<?php echo $_GET['memberid']; ?>&ltype=<?php echo $_GET['ltype']; ?>')" class="btn btn-sm btn-secondary float-right">Print</button>
                </div>
              </div>
						</div>

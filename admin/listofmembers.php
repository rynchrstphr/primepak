    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-gray-800">List of Members</h1>
        </div>
            ...
            <div class="card-body">
              <div class="form-group row">
                ...
                <?php 
                  ...
                  $sql = "SELECT * FROM memberdetailstbl WHERE status = 'active';";
                    ...
                    <?php 
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;"> 
                          ...
                          <a href="listofmembers.php?deactivate=<?php echo $row['memberid']; ?>" class="btn btn-danger btn-circle btn-sm" style="margin-left: 5px;" onclick="return confirm('Deactivate Account?');">
